...
<div class="form-payment__container form-payment__ru">
    ...
    <form class="form form-payment--loading"
        ...
        <input type="hidden" name="active_form_id" value="form_1">
            ...
            <div class="field">
                <div class="work-variants">
                    {set $work_types = [
                        ...
                        'kursovaya' => ['label' => 'Курсовая', 'price' => 80],
                        'paper' => ['label' => 'Краеведение', 'price' => 100],
                        'diplom' => ['label' => 'Юбилейная дата', 'price' => 'custom']
                    ]}
                ...
                <div class="price">
                    ...
                    <span>
                        <span class="price-value" id="priceValue">
                            {if $work_types[$work_type].price == 'custom'}
                                Договорная
                            {else}
                            ...
                            <div class="price-helper-tooltip">
                                <div class="tooltip-content">
                                    <div class="tooltip">
                                        ...
                                        <span id="tooltipWorkType" class="tooltip__value">{$work_types[$work_type].label}</span>
                                    </div>
                                    <div class="tooltip">
                                        <span class="tooltip__label">Количество источников:</span>
                                        <span class="tooltip__value">Цена не&nbsp;зависит от&nbsp;количества</span>
                                    </div>
                                    <div class="tooltip">
                                        <span class="tooltip__label">Цена за источник:</span>
                                        <span id="tooltipPricePerSource" class="tooltip__value">
                                            {if $work_types[$work_type].price == 'custom'}
                                                Договорная
                                            {else}
