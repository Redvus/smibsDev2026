...
<div class="form-payment__container form-payment__ru">
    <h2 class="form-payment__title simple-title">Заявка на&nbsp;список редактируемых источников</h2>
    ...
    <form class="form form-payment--loading"
        ...
        <input type="hidden" name="active_form_id" value="form_2">
                ...
                <div class="work-variants">
                    ...
                    {foreach $work_types as $value => $data}
                        <div class="variant-container">
                            <label class="variant">
                                <input type="radio" class="variant__radio work-type-radio" name="work_type" value="{$value}"
                                    data-price="{$data.price}" {$work_type == $value ? 'checked' : ''}>
                        ...
                        <span class="price-helper-wrapper">
                            ...
                            <div class="price-helper-tooltip">
                                <div class="tooltip-content">
                                    {* <div class="tooltip">
                                        <span class="tooltip__label">Тип работы:</span>
                                        <span id="tooltipWorkType" class="tooltip__value">{$work_types[$work_type].label}
                                    </div> *}
                                    <div class="tooltip">
                                        <span class="tooltip__label" class="tooltip__value">Количество источников:</span>
                                        <span id="tooltipRefs">{$need_refs}</span>
                                    </div>
                                    <div class="tooltip">
                                        <span class="tooltip__label">Цена за источник:</span>
                                        <span id="tooltipPricePerSource" class="tooltip__value">{$work_types[$work_type].price} ₽</span>
                                    </div>
                                    {* <div class="tooltip">
